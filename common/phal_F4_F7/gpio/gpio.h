...
// I2C
#define GPIO_INIT_I2C1_SCL_PB8 GPIO_INIT_AF(GPIOB, 8, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C1_SDA_PB9 GPIO_INIT_AF(GPIOB, 9, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C2_SCL_PB10 GPIO_INIT_AF(GPIOB, 10, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
#define GPIO_INIT_I2C2_SDA_PB11 GPIO_INIT_AF(GPIOB, 11, 4, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_PULL_UP)
