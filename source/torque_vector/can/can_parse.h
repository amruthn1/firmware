...
#define ID_TV_VERSION 0x10401600
...
#define SEND_TV_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_TV_VERSION, .DLC=DLC_TV_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->tv_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
