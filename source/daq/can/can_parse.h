...
#define ID_DAQ_VERSION 0x10200400
...
#define SEND_DAQ_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_DAQ_VERSION, .DLC=DLC_DAQ_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->daq_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
