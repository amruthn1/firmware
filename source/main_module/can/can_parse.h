...
#define ID_MAIN_VERSION 0x10c02200
#define ID_FAULT_SYNC_MAIN_MODULE 0xc02400
#define ID_DAQ_RESPONSE_MAIN_MODULE_VCAN 0x8c02600
...
#define ID_FAULT_SYNC_PDU 0x1601200
#define ID_FAULT_SYNC_DASHBOARD 0xa01800
#define ID_FAULT_SYNC_A_BOX 0x1402600
#define ID_FAULT_SYNC_TORQUE_VECTOR 0x401800
...
#define SEND_MAIN_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_MAIN_VERSION, .DLC=DLC_MAIN_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->main_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
