...
#define ID_ABOX_VERSION 0x11402400
#define ID_FAULT_SYNC_A_BOX 0x1402600
#define ID_DAQ_RESPONSE_A_BOX_VCAN 0x9402800
...
#define SEND_ABOX_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_ABOX_VERSION, .DLC=DLC_ABOX_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->abox_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
