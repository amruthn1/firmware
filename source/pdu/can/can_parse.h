...
#define ID_PDU_VERSION 0x11601000
#define ID_FAULT_SYNC_PDU 0x1601200
#define ID_DAQ_RESPONSE_PDU_VCAN 0x9601400
...
#define SEND_PDU_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_PDU_VERSION, .DLC=DLC_PDU_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->pdu_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
