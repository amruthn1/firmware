...
#define ID_DASH_VERSION 0x10a01600
#define ID_FAULT_SYNC_DASHBOARD 0xa01800
#define ID_DAQ_RESPONSE_DASHBOARD_VCAN 0x8a01a00
...
#define SEND_DASH_VERSION(git_hash_) do {\
        CanMsgTypeDef_t msg = {.Bus=CAN1, .ExtId=ID_DASH_VERSION, .DLC=DLC_DASH_VERSION, .IDE=1};\
        CanParsedData_t* data_a = (CanParsedData_t *) &msg.Data;\
        data_a->dash_version.git_hash = git_hash_;\
        canTxSendToBack(&msg);\
    } while(0)
